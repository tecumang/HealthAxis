                ...
                <div class="card-body p-5">
                    ...
                    <div class="text-center mb-4">
                        <div class="bg-light rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width: 70px; height: 70px;">
                            <i class="fas fa-ribbon text-primary" style="font-size: 28px;"></i>
                        </div>
                        <h3 class="fw-bold">Pathlab Login</h3>
                    ...
                    <form method="POST" action="{{ route('franchise-logins') }}" class="mt-4">
                        ...
                        <div class="d-grid gap-2 mb-4">
                            ...
                            <p class="text-center">If You Forget Password, Contact Admin</p>
                        </div>
