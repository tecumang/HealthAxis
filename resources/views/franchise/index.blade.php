...
<div class="container-fluid py-4 px-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            @if(!$reporttemplate && empty($profile['franchise_scanner']))
            <div class="alert alert-warning" role="alert">
                <strong>Warning!</strong> Please upload your report template and Payment scanner in the profile section.
            </div>
            @elseif(!$reporttemplate)
            <div class="alert alert-warning" role="alert">
                <strong>Warning!</strong> Please upload your report template in the profile section.
            </div>
            @elseif(empty($profile['franchise_scanner']))
            <div class="alert alert-warning" role="alert">
                <strong>Warning!</strong> Please upload your Payment scanner in the profile section.
            </div>
            @endif
        </div>
        <div class="col-12">
            <h2 class="dashboard-title">{{$profile['name']}} - Pathlab Dashboard</h2>

            <!-- Quick Actions -->
            <div class="row quick-actions mb-4">
                <div class="col">
                    <a href="{{route('franchise.addpatients')}}" class="action-button">
                        <div class="action-icon">
                            <i class="fas fa-person"></i>
                        </div>
                        <h6 class="action-title">Add Patient</h6>
                    </a>
                </div>
                <div class="col">
                    <a href="{{route('franchise.add.test')}}" class="action-button">
                        <div class="action-icon">
                            <i class="fas fa-vial"></i>
                        </div>
                        <h6 class="action-title">New Test</h6>
                    </a>
                </div>
                <div class="col">
                    <a href="{{route('franchise.report')}}" class="action-button">
                        <div class="action-icon">
                ...
                <div class="col">
                    <a href="{{route('franchise.transaction')}}" class="action-button">
                        <div class="action-icon">
                            <i class="fas fa-money-bill-wave"></i>
                        </div>
                        <h6 class="action-title">Transactions</h6>
                    </a>
                </div>
                <div class="col">
                    <a href="{{route('franchise.appoint')}}" class="action-button">
                        <div class="action-icon">
                            <i class="fa-regular fa-calendar-check"></i>
                        </div>
                        <h6 class="action-title">Appointment</h6>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="stat-card stat-card-primary">
                <div class="card-body">
                    ...
                    <h3 class="stat-card-value">{{$totalpatient}}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
        ...
        <div class="col-md-4 mb-4">
            <div class="stat-card stat-card-warning">
                <div class="card-body">
                    ...
                    <h3 class="stat-card-value">₹{{$totalRevenue}}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="stat-card stat-card-danger">
                <div class="card-body">
                    ...
                    <h6 class="stat-card-title">Active Patients</h6>
                    <h3 class="stat-card-value">{{$activepatient}}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
